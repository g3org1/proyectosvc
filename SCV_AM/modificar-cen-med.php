...
<head>
	...
	<title>Modificar Centro Medico</title>
        ...
        <form class="form-register" method="post" action="#">
            ...
            <div class="form-register-with-email">
              ...
              <div class="form-title-row">
                        ...
                        <br><h1>Modificar Centro Médico</h1>
                    </div>

                    <p style="font-size: 10px; color: #7ec1d2;"> NOTA: Para modificar un Nuevo Centro Medico son de llenado Obligatorios los campos con (*)</p>
                    <br>
