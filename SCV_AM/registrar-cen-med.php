            ...
            <div class="form-register-with-email">
                ...
                <?php
                    ...
                    <div class="form-title-row">
                        <h1>Nuevo Centro Medico</h1>
                    </div>
                    <p style="font-size: 10px; color: #7ec1d2;"> NOTA: Para el Ingreso de un Nuevo Centro Medico son de llenado Obligatorios los campos con (*)</p>
                    <br>
                    <div class="form-row" >
                        <label>
                            <span>RUN (*)</span>
                            <input type="text" id="run" name="run" placeholder="Ej: 17.789.324-k" required="" oninput="checkRut(this)">
                      ...
                      <div class="form-row">
                        <label>
                            <span>Nombre (*)</span>
                            <input type="text" name="nombre" placeholder="Ej: SCV AYUDAMED" required="">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                      <label>
                          <span>Telefono (*)</span>
                          <input type="text" name="telefono" placeholder="Ej: (XXX) XXXXXXXX" required="">
                      </label>
                  </div>
                    ...
                    <div class="form-row">
                        <label>
                            ...
                            <input type="email"  name="correo" placeholder="Ej: Correo@scvayudamed.com" required=""  >
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Web (*)</span>
                            <input type="text"  name="link" placeholder="Ej: www.SCVAyudaMed.com" required=""  >
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Password (*)</span>
                            <input type="password"  name="pass" placeholder="Ingrese un password" required=""  >
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <button name="ingresar">Agregar</button>
