            ...
            <div class="form-register-with-email">
                ...
                <?php
                    ...
                    <div class="form-title-row">
                        ...
                        <br><h1>Nuevo Paciente</h1>
                    </div>

                    <br><p style="font-size: 10px; color: #7ec1d2;"> NOTA: Para el Ingreso de un Nuevo Paciente son de llenado Obligatorios los campos con (*)</p>
<br>
                    <div class="form-row" >
                        <label>
                            <span>Rut Paciente(*)</span>
                            <input type="text" id="rut" name="rut" placeholder="Ej: 17789324-k" required="" oninput="checkRut(this)">
                  ...
                  <div class="form-row">
                    <label>
                        ...
                        <input type="date" name="nacimiento" placeholder="E" required="">
                    </label>
                </div>
                ...
                <div class="form-row">
                  <label>
                      <span>Sexo(*)</span>
                      <p>Varón</p><input class="radiob" type="radio" name="sexo" value="varon" required="">
                      <p>Hembra</p><input class="radiob" type="radio" name="sexo" value="hembra"  required="">
                  </label>
              </div>
              ...
              <div class="form-row">
                  <label>
                      <span>Imagen</span>
                      <input id="foto" type="file"  name="foto" enctype="multipart/form-data" required="">
                  </label>
              </div>
              ...
              <div class="form-row">
                    ...
                    <div class="form-row">
                        <button name="ingresar"z>Registrar</button>
...
function ubicar(a,b){
      ...
      var objPunto=new google.maps.Marker({              //agregamos un tooltip al punto
...
function showPosition(a,b){
      ...
      var myOptions = { zoom: 15, //nivel de zoom para poder ver de cerca.
                        center: punto,
                        apTypeControl: false,
      ...
      var objPunto=new google.maps.Marker({ position:   punto,  //indicamos las coordenadas del punto
      	                                    map:        map, //este es el mapa que anteriormente creamos
                                          })
}
...
$( "document").ready(function() {
    ...
    $(".form-register").submit(function(event) {
        ...
        var ft = document.getElementById("foto").files[0].name;
        /*alert(ft2);*/
        datos=datos+"&latitud="+la+"&longitud="+lo+"&foto="+ft;
        /*alert(datos);*/


        $.ajax({
            data: datos,
            url: 'registro_pac.php',
            type: 'POST',
            beforeSend: function() {
            ...
            success: function(response){
                ...
                if(response == 1){
                    alert("Datos de paciente ingresado correctamente.\n Sera redireccionado al menu principal.");
                    $("#estado").html("");
