...
switch ($_GET["accion"])
{
	...
	case "generar_calendario":
	{
		...
		echo "<h2>Calendario de Eventos para: ".$meses[intval($fecha_calendario[1])]." de ".$fecha_calendario[0]." <abbr title='S&oacute;lo se pueden agregar eventos en d&iacute;as h&aacute;biles y en fechas futuras (o la fecha actual).'><i class='fa fa-question-circle' aria-hidden='true' style='color: #7ec1d2;'></i></abbr></h2>";
