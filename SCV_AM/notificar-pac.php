...
<head>
	...
	<title>Notificar a Correo</title>
  ...
  <body>
    <div class="main-content">
        <form class="mailto:correo" method="post">
...
-->
                    ...
                    <br><br>
                    <p style="font-size: 10px; color: #7ec1d2;"> NOTA: Para Notificar a un Usuario son de llenado Obligatorios los campos con (*)</p>
                    ...
                    <div class="form-row">
                        <label>
                          ...
                          <input type="text"  name="correo" placeholder="Ej: Correo@scvayudamed.com" required=""  >
                    ...
                    <div class="form-row">
                      <label>
                      <span>Mensaje </span>
                      <textarea cols="22" rows="10" name="texto" placeholder="Agrege su mensaje aqui..." ></textarea>
                      </label>
                      <div>
